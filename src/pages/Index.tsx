...
const courseModules = [{
  ...
  duration: "2 занятия",
  items: ["Теория + практика базовых вопросов + домашка (elevator pitch, заготовки)", "Продвинутая практика в группе + домашка (поиск стратегий компаний)"]
}, {
  title: "Модуль 2: Product Sense",
  duration: "3 занятия",
  items: ["Сегменты, гипотезы боли, приоритизация болей", "Решения, приоритизация, метрики, MVP, риски", "Разбор кейса вместе + домашка (письменно разобрать кейсы)"]
}, {
  title: "Модуль 3: Product Execution",
  duration: "5–6 занятий",
  items: ["Поиск NSM + домашка (20 NSM)", "Целевые и указательные метрики", "Контр-метрика и трейд-оффы", "Разбор кейсов Metrics & Success (1–2 занятия)", "Debugging / Root Cause Analysis", "Сложный кейс вместе + домашка (устный разбор с таймером)"]
}];
